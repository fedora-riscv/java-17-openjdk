...
%changelog
* Wed Dec 07 2022 Jiri Vanek <jvanek@redhat.com> - 1:17.0.5.0.8-3
- Flip the use of in-tree libraries back on by default, as in-tree libraries were since origin
  advertised as to be backportedm if they go ok in f37. This is now.
